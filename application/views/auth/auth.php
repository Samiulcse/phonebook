                ...
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
                        ...
                        <div id="register" class="animate form">
                            <form  action="<?php echo base_url('login/register_user') ?>" method="POST" autocomplete="on">
                                <h1> Sign up </h1>
                                <p>
                                    <label for="usernamesignup" class="uname" data-icon="u">Your username</label>
                                    <input id="usernamesignup" name="user_name" required="required" type="text" placeholder="mysuperusername690" />
                                <?php echo form_error('user_name', '<span class="error text-danger">', '</span>'); ?>
                                </p>
                                <!--<p>
