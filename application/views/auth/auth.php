                ...
                <div id="register" class="animate form">
                    <form id="register_form" autocomplete="on">
                        ...
                        <p>
                            ...
                            <input id="user_email" name="user_email" required="required" type="email"
                                   placeholder="mysupermail@mail.com"/>
                            <span class="error text-danger" id="user_email_error"></span>
                        </p>
                        <p>
                            <label for="passwordsignup" class="youpasswd" data-icon="p">Your password </label>
                            <input id="user_pass" name="user_pass" required="required" type="password"
                                   placeholder="eg. X8df!90EO"/>
                        ...
                        <p>
                            <label for="passwordsignup_confirm" class="youpasswd" data-icon="p">Please confirm your
                                password </label>
                            <input id="user_confirm_pass" name="user_confirm_pass" required="required" type="password"
                                   placeholder="eg. X8df!90EO"/>
